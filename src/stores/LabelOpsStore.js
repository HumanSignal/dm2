                  ...
                  "lops": [
                      {
                          "conflicts": 0,
                          "coverage": 0,
                          "factor": "[project...Feature Request]",
                          "id": 0,
                      ...
                      },
                      {
                          "conflicts": 0,
                          "coverage": 0,
                          "factor": "[the coordinates...Feature Request]",
                          "id": 1,
                          "label": "Feature Request",
                          "source": "heartex",
                          "type": "current"
                      },
                      {
                          "conflicts": 0,
                          "coverage": 0,
                          "factor": "[coordinates...Feature Request]",
                          "id": 2,
                          "label": "Feature Request",
                          "source": "heartex",
                          "type": "current"
                      ...
                      },
                      {
                          "conflicts": 0,
                          "coverage": 0,
                          "factor": "[happened the screen...Issue]",
                          "id": 4,
                          "label": "Issue",
                          "source": "heartex",
                          "type": "current"
                      },
                      {
                          "conflicts": 0,
                          "coverage": 0,
                          "factor": "[SYM] \"It would be great if the coordinates in the saved XML were relative, so that resizing the Image doesn't require to adjust the coordinates of the bounding boxes\"",
                          "id": 9,
                          "label": "Feature Request",
                          "source": "labeling",
                          "type": "current"
                      },
                      {
                          "conflicts": 0,
                          "coverage": 0,
                          "factor": "[SYM] \"Also it would be useful, if the paths were relative either to the Annotation or to a defineable location (like the project root directory of the developing project\"",
                          "id": 10,
                          "label": "Feature Request",
                          "source": "labeling",
                          "type": "current"
                  ...
                  "result": [
                      {
                          ...
                          "value": {
                              ...
                              "start": 0,
                              "text": "It would be great if the coordinates in the saved XML were relative, so that resizing the Image doesn't require to adjust the coordinates of the bounding boxes."
                          }
                      }
                  ]
              };
